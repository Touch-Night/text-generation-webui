...
if not exist "%INSTALL_ENV_DIR%" (
	...
	call "%CONDA_ROOT_PREFIX%\_conda.exe" create --no-shortcuts -y -k --prefix "%INSTALL_ENV_DIR%" -c https://repo.anaconda.com/pkgs/main/ python=3.11 || ( echo. && echo 创建Conda环境失败。 && goto end )
)
